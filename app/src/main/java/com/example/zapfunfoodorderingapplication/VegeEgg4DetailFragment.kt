...
import com.example.zapfunfoodorderingapplication.utils.VegeEgg4DetailViewModel
...
import kotlinx.android.synthetic.main.fragment_vege_egg4_detail.*
import kotlinx.android.synthetic.main.fragment_vege_egg4_detail.imgPork1
import kotlinx.android.synthetic.main.fragment_vege_egg4_detail.txtUserID

class VegeEgg4DetailFragment : Fragment()  {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_vege_egg4_detail, container, false)

        val btnBack: TextView = root.findViewById(R.id.txtBack)
        btnBack.setOnClickListener{view : View ->
            view.findNavController().navigate(R.id.action_vegeEgg4DetailFragment_to_myMenuFragment)}

        initVegeEgg4Views(root)
    ...
    private fun initVegeEgg4Views(root: View?) {
    ...
    private fun saveCart() {
        ...
        ref.child(item_id!!).setValue(cart).addOnCompleteListener{
            ...
            requireView().findNavController().navigate(R.id.action_vegeEgg4DetailFragment_to_myMenuFragment)
        }
    }
