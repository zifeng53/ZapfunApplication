...
import kotlinx.android.synthetic.main.fragment_vege_egg1_detail.imgPork1
import kotlinx.android.synthetic.main.fragment_vege_egg1_detail.txtUserID
...
class VegeEgg1DetailFragment : Fragment() {
    ...
    private fun saveCart() {
        ...
        ref.child(item_id!!).setValue(cart).addOnCompleteListener{
            ...
            requireView().findNavController().navigate(R.id.action_vegeEgg1DetailFragment_to_myMenuFragment)
        }
    }
